import {SatelliteEntity, GroundStationEntity} from "./CesiumModules.js"
...
export class SatelliteManager {
  constructor(viewer) {
    ...
    this.satellites = [];
    this.enabledComponents = ["Point", "Model", "Orbit track"];
    this.enabledTags = [];
  ...
  addFromTle(tle, tags, properties) {
    const sat = new SatelliteEntity(this.viewer, {propogator: "SGP4", tle: tle, ...properties}, tags);
    this.add(sat);
  }
